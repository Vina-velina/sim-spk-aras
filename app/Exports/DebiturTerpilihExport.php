...
class DebiturTerpilihExport implements FromQuery, WithTitle, WithHeadings, WithStyles, ShouldAutoSize, WithEvents, WithMapping
{
    ...
    {
        $data_debitur = DebiturTerpilih::query();
        $data_debitur->where('id_periode', $this->id_periode);
        $data_debitur->where('status', 'publish');
