                                    ...
                                    <div class="card-options ml-auto">
                                        <div class="btn-group ml-5 mb-0">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right shadow">
                                                ...
                                                <a class="dropdown-item" href="#"><i
                                                        class="fe fe-eye mr-2"></i>View all new tab</a>
                                                <a class="dropdown-item" href="#"><i
                            ...
                            <div class="card-body iconfont text-left">
                                ...
                                <div class="d-flex mb-0">
                                    <div class="">
                                        ...
                                        <p class="mb-2 tx-12 text-muted"><i
                                                class="fas fa-arrow-circle-down text-success"></i> Compared to
                                            Last week</p>
                                    </div>
                                ...
                                <div class="row row-sm">
                                    <div class="col-xl-7 col-lg-7 mx-auto d-block">
                                        <div class="progress mg-b-10 rounded-20">
                                            <div class="progress-bar ht-25 wd-50p bg-success tx-14" role="progressbar"
                                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Online Revenue
                                            </div>
                                            <div class="progress-bar ht-25 wd-50p bg-primary tx-14" role="progressbar"
                                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Offline Revenue
                                            </div>
                                        </div>
                                        <div class="row mb-0">
                                            <div class="col-6">
                    ...
                    <div class="card-body pd-20">
                        <div class="">
                            ...
                            <div class="d-flex mg-t-25">
                                <div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10"
                                    data-color="#5066e0"><canvas width="140" height="140"></canvas>
                            ...
                            <div class="d-flex mg-t-20">
                                <div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10"
                                    data-color="#ff8c00"><canvas width="140" height="140"></canvas>
                                    <div class="chart-circle-value">
                                        <div class="tx-14 font-weight-bold">65%</div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex mg-t-20">
                                <div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10"
                                    data-color="#00d48f"><canvas width="140" height="140"></canvas>
                                    <div class="chart-circle-value">
                                        <div class="tx-14 font-weight-bold">65%</div>
                                    </div>
                                </div>
                            ...
                            <a class="btn btn-light btn-block mg-t-20" href="#"><i class="fe fe-plus"></i>
                                Add New Project</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-options ml-auto">
                                <div class="btn-group ml-5 mb-0">
                                    ...
                                    <div class="dropdown-menu shadow">
                                        <a class="dropdown-item" href="#"><i class="fe fe-plus mr-2"></i>Add
                                            New</a>
                                        <a class="dropdown-item" href="#"><i class="fe fe-eye mr-2"></i>View all
                                            new tab</a>
                                        <a class="dropdown-item" href="#"><i class="fe fe-edit mr-2"></i>Edit
                                            Card</a>
                                        <a class="dropdown-item" href="#"><i class="fe fe-settings mr-2"></i>
