                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.master-data.periode.update', $periode->id) }}" method="POST">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    <textarea class="form-control form-control-sm" name="keterangan" placeholder="Masukkan Keterangan" type="text">{{ $periode->keterangan }}</textarea>
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    <input class="form-control form-control-sm" name="tgl_awal_penilaian"
                                        ...
                                        value="{{ date('Y-m-d', strtotime($periode->tgl_awal_penilaian)) }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    <input class="form-control form-control-sm" name="tgl_akhir_penilaian"
                                        ...
                                        value="{{ date('Y-m-d', strtotime($periode->tgl_akhir_penilaian)) }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mg-t-5">
                                    <input class="form-control form-control-sm" name="tgl_pengumuman"
                                        placeholder="Masukkan Tanggal Akhir Penilaian" type="date"
                                        value="{{ date('Y-m-d', strtotime($periode->tgl_pengumuman)) }}">
                                </div>
                            </div>
