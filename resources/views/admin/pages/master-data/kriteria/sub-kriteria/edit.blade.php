        ...
        <div class="row row-sm">
            <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.master-data.sub-kriteria.update', [$kriteriaPenilaian->id, $subKriteriaPenilaian->id]) }}"
                            method="POST">
                            @csrf
                            ...
                            <a href="{{ route('admin.master-data.kriteria.edit', [$kriteriaPenilaian->id, $kriteriaPenilaian->id]) }}"
