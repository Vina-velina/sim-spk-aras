...
<head>
    ...
    <title>{{ config('app.name') }} - Konfirmasi Lupa Kata Sandi</title>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        akun {{ config('app.name') }} Anda, silahkan
                                                                        tekan tombol
                                                                        dibawah
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#26A4D3;background:rgba(72, 134, 255);border-width:0px;display:inline-block;border-radius:50px;width:auto"><a
                                                                            href="{{ $link }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;border-style:solid;border-color:rgba(72, 134, 255);border-width:15px 30px 15px 30px;display:inline-block;background:rgba(72, 134, 255);border-radius:50px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center">Reset
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>{{ config('app.name') }}</strong> by
                                                                        <strong>GanaDev
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        {{ config('app.name') }} adalah nama bisnis
                                                                        terdaftar yang
