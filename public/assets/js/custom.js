    ...
    $(function () {
        ...
        $(".rating-stars").ratingStars({
            ...
            $(document).on("click", "#myonoffswitch14", function () {
                this.checked
                    ? ($("body").addClass("header-light"),
                      ...
                      $("body").removeClass("reset-header"),
                      localStorage.setItem("header-light", "True"))
                    : ($("body").removeClass("header-light"),
                      localStorage.setItem("header-light", "false"));
            }),
            ...
            $(document).on("click", "#myonoffswitch17", function () {
                this.checked
                    ? ($("body").addClass("reset-header"),
                      $("body").removeClass("header-color"),
                      $("body").removeClass("header-light"),
                      $("body").removeClass("header-dark"),
                      localStorage.setItem("reset-header", "True"))
                    : ($("body").removeClass("reset-header"),
                      localStorage.setItem("reset-header", "false"));
            }),
